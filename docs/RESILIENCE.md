...
**Run:** 2026-08-02 10:57 UTC · **Code:** `bafd78a (working tree dirty)` · Reproduce with `make resilience-bench`.
...
Cold resume latency: p50 **6607 ms**,
p95 **6694 ms**,
p99 **6838 ms** (n=50).
...
Resume latency after a real kill: p50 **6566 ms**,
p95 **6627 ms** (n=10).
...
Resume latency after an AWS-initiated kill: p50 **8836 ms**,
p95 **9019 ms** (n=15).
...
| --- | --- | --- | --- | --- | --- |
| 10 | 8.7 | 1132 | 1144 | 1.1 | 0 |
| 50 | 34.7 | 1331 | 1422 | 1.4 | 0 |
| 100 | 55.7 | 1643 | 1753 | 1.8 | 0 |
...
| --- | --- | --- | --- | --- |
| 100 | 44 | 58 | 381 | 392 |
| 1,000 | 65 | 104 | 400 | 438 |
| 5,000 | 85 | 395 | 415 | 653 |
| 10,000 | 107 | 650 | 437 | 945 |

Across a **100× larger corpus** (100 → 10,000 vectors), on a warm connection:

- **C-SPANN: 44 ms → 107 ms** (2.43×)
- **Full scan: 58 ms → 650 ms** (11.18×)
- At 10,000 vectors the index is **6.1× faster**, and the gap widens with every row added.
