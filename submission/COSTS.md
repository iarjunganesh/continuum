...
read live off the console before the cutoff (the screenshots were later deleted as stale — the billing console is the authority, and these are the figures it showed):
