...
push → ruff lint → ruff format --check → mypy → Devpost mirror freshness
     ...
     → pytest (72 unit + 9 integration) → coverage (≥90% gate, 100% measured) → Codecov
